...
from app.routers import sites, jepx, substations, solar, curtailment, hazard, fit_solar, evaluate, demand, outage_ev, bess, reinfolib, cases, slack, simulate, agent, fude, mesh, energy_sources, email_notify, scan
...
app.include_router(outage_ev.router, prefix="/api/v1")
app.include_router(bess.router, prefix="/api/v1")
app.include_router(reinfolib.router, prefix="/api/v1")
...
app.include_router(energy_sources.router, prefix="/api/v1")
